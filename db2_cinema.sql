...
--
-- Máy chủ: localhost
-- Thời gian đã tạo: Th6 02, 2024 lúc 05:25 AM
...
--
ALTER TABLE `payment`
  MODIFY `payment_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;
...
--
ALTER TABLE `ticket`
  MODIFY `ticket_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=72;
